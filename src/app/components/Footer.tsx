          ...
          <div className='space-y-2 text-sm'>
            ...
            <div className='flex'>
              ...
              <Link href="03302354356" aria-label='My Phone Number'
               title="nmbr"  className='transition-colors duration-300 text-white text-secondary hover:text-violet-400'>03302354356</Link>
               <br />
            </div>
            ...
            <div className='flex'>
              ...
              <Link href="Email" aria-label='My Email'
               title="mail"  className='transition-colors duration-300 text-white text-secondary hover:text-violet-400'>faqehanoor@gmail.com</Link>
               <br />
            </div>
            ...
            <div className='flex'>
              ...
              <Link href="https://www.linkedin.com/in/faqeha-noor-2b5a4a254/" aria-label='LinkedIn'
               title="in"  className='transition-colors duration-300 text-white text-secondary hover:text-violet-400'>Faqeha Noor</Link>
               <br />
            </div>
